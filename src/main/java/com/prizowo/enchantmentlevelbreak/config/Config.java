package com.prizowo.enchantmentlevelbreak.config;

import com.prizowo.enchantmentlevelbreak.Enchantmentlevelbreak;
...
public class Config {
    ...
    private static final ForgeConfigSpec.BooleanValue ALLOW_VANILLA_LEVEL_STACKING_VALUE = BUILDER
